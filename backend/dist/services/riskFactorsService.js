import { deals, activities, accountById, repById, } from "../data/index.js";
import { parseDate, daysAgo } from "../utils/date.js";
import { OPEN_STAGES, STALE_DAYS, LOW_ACTIVITY_THRESHOLD, UNDERPERFORMING_WIN_RATE_GAP, MIN_DEALS_FOR_REP_METRICS, MAX_STALE_DEALS_RETURNED, MAX_UNDERPERFORMING_REPS, MAX_LOW_ACTIVITY_ACCOUNTS, } from "../utils/constants.js";
...
export function getRiskFactors() {
    ...
    for (const [repId, rep] of repById) {
        ...
        if (w + l < MIN_DEALS_FOR_REP_METRICS)
            continue;
        const wr = (w / (w + l)) * 100;
